 ...
 * @author user
 */
public class OfficeSuppliesOrderApprovalForm extends javax.swing.JFrame {
     ...
     * @param entity
     */
    public OfficeSuppliesOrderApprovalForm(Entity entity) {
        initComponents();
        setupWindow();
    ...
    private void initComponents() {
        ...
        menu1.setText("Goods Order Approval");
    ...
    private void btnDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetailActionPerformed
        new OfficeSuppliesOrderDetailForm(this, entity).show(getSelectedID(), 
                OfficeSuppliesOrderDetailForm.VIEW, 
                () -> loadDataTable());
    ...
    private void loadDataTable() {
       ResultSet rs = sellDao.findBy(dtRequestFrom.getDate(), 
